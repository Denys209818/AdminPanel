...
namespace IdentityAdminPanel.Areas.Admin.Controllers
{
    [Area("Admin")]
    ...
    public class HomeController : Controller
    {
        ...
        public HomeController(UserManager<AppUser> userManager, RoleManager<AppRole> roleManager, EFContext context)
        {
        ...
        public async Task<IActionResult> EditRole(string email, string role) 
        {
            ...
            if (user != null) 
            {
                switch (role) 
                {
                    ...
                    case "isVip": 
                        {
                            await _userManager.AddToRoleAsync(user, Roles.Vip);
                            break; 
                        }
                    case "isAdmin": 
                        {
