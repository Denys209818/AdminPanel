#pragma checksum "C:\Users\Denis\Desktop\ASP.NET Core MVC\HomeWorks\IdentityAdminPanel\IdentityAdminPanel\Areas\Admin\Views\Shared\_Navigation.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "febcd35906677b5a80f6914b73c7eccccafffa27"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"febcd35906677b5a80f6914b73c7eccccafffa27", @"/Areas/Admin/Views/Shared/_Navigation.cshtml")]
    ...
    <div class=""sidebar-collapse"">
        <ul class=""nav nav-tabs metismenu"" id=""side-menu"">
            ...
            <li class=""nav-item"">
                <a href=""#edituser"" class=""nav-link"" dat");
            WriteLiteral(@"a-bs-target=""#edituser"" data-bs-toggle=""tab""><i class=""fa fa-diamond""></i> <span class=""nav-label"">Редагувати користувача</span></a>
            </li>
            <li class=""nav-item"">
            ...
            <li class=""nav-item"">
                <a href=""#editrole"" class=""nav-link"" data-bs-target=""#editrole"" data-bs-toggle=""tab""><i class=""fa fa-desktop""></i> <span class=""nav-label"">Керування ролями</span></a>
            </li>
            <li class=""nav-item"">
                <a href=""#editimage"" class=""nav-link"" data-bs-target=""#editimage"" data-bs-toggle=""tab""><i class=""fa fa-apple""></i> <span class=""nav-label"">Змінити зображення</span></a>
            </li>
        </ul>
    </div>
</nav>");
